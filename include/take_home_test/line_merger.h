#ifndef TAKE_HOME_TEST_LINE_MERGER_H
#define TAKE_HOME_TEST_LINE_MERGER_H
...
namespace lines
{
    ...
    private:
         ...
         */
        void updateSlopeGroups(const std::vector<modifiedSlopeGroup_t> &slopeGroup_vec);
         ...
         * @param slopeGroup
         */
        void updateSlopeGroup(slopeGroup_t &slopeGroup);
...
#endif // TAKE_HOME_TEST_LINE_MERGER_H